  ...
  if (movie.cardType === "top10") {
    ...
    return (
      <div className="relative group overflow-hidden">
        ...
        />
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black/40 to-black opacity-0 group-hover:opacity-100 transition-opacity duration-500">
